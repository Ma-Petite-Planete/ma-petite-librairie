...
var _path$z, _path2$c, _path3$5, _path4, _path5, _path6, _path7, _path8, _path9;
...
var SvgTail = function SvgTail(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$6({
    ...
    d: "M15.03 0c.078 4.397.374 7.1 1.496 9.304A14 14 0 0 0 20 13.668V14h-6C6.268 14 0 7.732 0 0z"
  })));
};

var _g, _path$5, _defs;
...
var SvgSentStatus = function SvgSentStatus(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$4({
    ...
    stroke: "#A3E1F0",
    strokeWidth: 0.5,
    d: "M11.633.36 4.036 8.335.866 5.009a.35.35 0 0 0-.51 0 .393.393 0 0 0 0 .537L3.78 9.139a.35.35 0 0 0 .511 0L12.144.897a.39.39 0 0 0 0-.536.35.35 0 0 0-.51 0z"
  })));
};

var _path$3, _path2$2;
function _extends$3() { return _extends$3 = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends$3.apply(null, arguments); }
var SvgSendingStatus = function SvgSendingStatus(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$3({
    ...
    fill: "#fff",
    d: "M6.655 11.97a6.012 6.012 0 0 1-6.62-6.62C.33 2.564 2.568.33 5.348.033a6.007 6.007 0 0 1 6.617 6.62c-.292 2.781-2.527 5.02-5.311 5.316M6.432.745A5.28 5.28 0 0 0 .745 6.432c.203 2.554 2.273 4.624 4.827 4.827a5.28 5.28 0 0 0 5.687-5.683C11.056 3.018 8.986.952 6.432.745"
  })), _path2$2 || (_path2$2 = /*#__PURE__*/React.createElement("path", {
    fill: "#fff",
    d: "M8.86 7.096H5.745a.52.52 0 0 1-.518-.519V3.462c0-.157.092-.311.245-.361a.366.366 0 0 1 .484.346v2.812c0 .057.046.103.104.103h2.812c.238 0 .426.23.346.484-.043.154-.196.25-.358.25"
  })));
};

var _path$2, _path2$1;
function _extends$2() { return _extends$2 = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends$2.apply(null, arguments); }
var SvgFailedStatus = function SvgFailedStatus(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$2({
    ...
    fill: "#fff",
    d: "M.429 10a.427.427 0 0 1-.303-.73L9.269.125a.427.427 0 1 1 .605.605L.731 9.875a.43.43 0 0 1-.302.124"
  })), _path2$1 || (_path2$1 = /*#__PURE__*/React.createElement("path", {
    fill: "#fff",
    d: "M9.57 9.999c-.109 0-.218-.04-.302-.125L.126.731A.427.427 0 1 1 .73.126l9.143 9.143a.427.427 0 0 1-.303.73"
  })));
};
...
var SvgProfile = function SvgProfile(props) {
  return /*#__PURE__*/React.createElement("svg", _extends$1({
    ...
    d: "M6.5 6.5a3.25 3.25 0 1 0 0-6.5 3.25 3.25 0 0 0 0 6.5"
  })), _path2 || (_path2 = /*#__PURE__*/React.createElement("path", {
    fillRule: "evenodd",
    d: "M6.5 7.313C4.33 7.313 0 8.4 0 10.563V13h13v-2.437c0-2.162-4.33-3.25-6.5-3.25",
    clipRule: "evenodd"
  })));
};
...
var SvgArrowDown = function SvgArrowDown(props) {
  return /*#__PURE__*/React.createElement("svg", _extends({
    ...
    stroke: "#fff",
    strokeWidth: 0.3,
    d: "M14.448 1.179c-.009.123-.04.245-.09.356a.9.9 0 0 1-.202.288L7.854 8.21a.8.8 0 0 1-.346.21l-.133.027h-.001a.74.74 0 0 1-.338-.046.8.8 0 0 1-.289-.191L.445 1.824h.001a.9.9 0 0 1-.203-.289A1.06 1.06 0 0 1 .19.812 1 1 0 0 1 .348.485.9.9 0 0 1 .609.251a.75.75 0 0 1 .664-.04.8.8 0 0 1 .285.203L7.3 6.232 13.048.41a.8.8 0 0 1 .28-.2.74.74 0 0 1 .664.041q.153.088.262.234a1 1 0 0 1 .158.327c.033.118.045.243.036.367Z"
  })));
};
...
const MppIcons = {
    ...
    add: SvgAdd,
    communication: SvgCommunication,
    chatTail: SvgTail,
    play: SvgPlay,
    sentStatus: SvgSentStatus,
    sendingStatus: SvgSendingStatus,
    failedStatus: SvgFailedStatus,
    profile: SvgProfile,
 ...
 * ```
 */
const MppMenu = ({ navigationLinks, LinkComponent, boType, onLogout, actualPage, aboutText, logOutText, profileLink, clientIsLoad, clientName, codeClientInput, codeClientButton, backToClientsLink, languageToggle, }) => {
    var _a;
    ...
    return (React__default.createElement("div", { className: "menu_background" },
        ...
        React__default.createElement("div", { className: "navigation_background" },
            ...
            languageToggle,
            boType === BoType.gpBo ? (React__default.createElement("div", { className: "navigation_element bottom" },
                React__default.createElement(LinkComponent, { href: profileLink.navigation, className: "navigation_flex bottom_align", target: (_a = profileLink.target) !== null && _a !== void 0 ? _a : '' },
                    React__default.createElement(profileLink.icon, { className: "icon_bottom" }),
                    React__default.createElement("p", { className: "text_body_sb" }, profileLink.name)))) : (React__default.createElement("div", { className: "navigation_element bottom", onClick: onLogout },
...
const MppChallengeCard = ({ title, subtitle, ranking, value, boType = BoType.scoBO, rankingColor, }) => {
    ...
    return (React__default.createElement("div", { className: `challenge_card__container ${boType === BoType.gpBo ? 'padding_ecu' : ''} ${title ? '' : 'loading'}` },
        React__default.createElement("div", { className: "challenge_card__ranking_title" },
            ranking && (React__default.createElement("div", { className: "challenge_card__ranking text_body_sb", style: { backgroundColor: `${rankingColor !== null && rankingColor !== void 0 ? rankingColor : GpColors.teal}` } }, ranking)),
